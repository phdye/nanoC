...
Program (
    ...
    StructDecl Rect (VarDecl(struct Point), VarDecl(struct Point))
    FuncDecl main() (int) (
        VarDecl(struct Rect)
        (((r.topLeft).x) = 1)
        (((r.topLeft).y) = 2)
        (((r.bottomRight).x) = 3)
        (((r.bottomRight).y) = 4)
        Func Call print_i (((r.topLeft).x) )
        Func Call print_c (10 )
        Func Call print_i (((r.topLeft).y) )
        Func Call print_c (10 )
        Func Call print_i (((r.bottomRight).x) )
        Func Call print_c (10 )
        Func Call print_i (((r.bottomRight).y) )
        return( 0 )
    )
)
*/
